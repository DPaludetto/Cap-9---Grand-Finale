...
fun getAllGames(): List<Game> {
    return listOf(
        ...
        Game(id = 2, title = "Battle Toads", studio = "TradeWest", releaseYear = 1991),
        Game(id = 3, title = "Enduro", studio = "Activision", releaseYear = 1983),
        Game(id = 4, title = "Ikari Warriors", studio = "SNK", releaseYear = 1986),
        Game(id = 5, title = "Capitain Commando", studio = "Capcom", releaseYear = 1991),
        ...
        Game(id = 11, title = "Bowlingt", studio = "Taito", releaseYear = 1979),
        Game(id = 12, title = "Black Jack", studio = "Capcom", releaseYear = 1978),
        Game(id = 13, title = "Bloom", studio = "Capcom", releaseYear = 1983),
        Game(id = 13, title = "Breakaway", studio = "Capcom", releaseYear = 1977)
    )
}

fun getGamesByStudio(studio: String): List<Game>{
    return getAllGames().filter {
        it.title.startsWith(prefix = studio, ignoreCase = true)
    }
}
