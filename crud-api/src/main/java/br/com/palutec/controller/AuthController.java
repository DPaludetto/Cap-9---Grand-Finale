...
public class AuthController {
	...
	private static final String SECRET_KEY = "tGWffxzzyJLRhUtLbzTwVqKpFTgQmfNUEJnwkPAmpmSLvffhFNFFNZMTXpFzSJfKtTjXaatdYzRhQcydtDhhVufJugbxuaLYVLupYwNmXqURFJdUSVJqBBmVMDiCAhfw";
	...
	public ResponseEntity<Object> login(@RequestBody Map<String, String> form) {
		...
		String token = createJWT(user.getId(), "br.com.palutec", user.getName(), 60*60*1000, userInfo);
