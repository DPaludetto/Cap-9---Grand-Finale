...
class WaterNotificationService(
    ...
    fun showBasicNotification() {
        val notification = NotificationCompat.Builder(context, "Mentoria Acadêmica")
            .setContentTitle("Sujestão de Conexão")
            .setContentText("Conexão Aluno x Mentor identificada")
